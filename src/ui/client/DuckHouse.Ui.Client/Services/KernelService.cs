...
internal class KernelService(HttpClient httpClient) : IKernelService
{
    ...
    public async Task<ExecutionResult> ExecuteAsync(string nodeName, string kernelId, ExecuteKernelRequest request, CancellationToken cancellationToken = default)
    {
