...
window.datatealMonacoReady = new Promise(function (resolve) {
    function check() {
        if (window._datatealThemesReady && window._datatealLanguageReady && window._datatealPythonReady) {
            resolve();
        }
    }
...
window.registerSemanticTokensCell = function (dotNetRef, modelUri) {
    ...
    if (!registry.registered) {
        ...
        registry.disposable = monaco.languages.registerDocumentSemanticTokensProvider('datateal-python', {
