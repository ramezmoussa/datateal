// Custom Python Monarch grammar for Datateal.
// Registers 'datateal-python' with differentiated keyword categories,
...
require(['vs/editor/editor.main'], function () {
    ...
    monaco.languages.setLanguageConfiguration('datateal-python', {
    ...
    monaco.languages.setMonarchTokensProvider('datateal-python', {
        defaultToken: '',
        tokenPostfix: '.python',
    ...
    // Signal readiness.
    window._datatealPythonReady = true;
    if (window._datatealPythonResolve) window._datatealPythonResolve();
});
