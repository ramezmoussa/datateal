...
/// <summary>
/// Builds the Datateal-specific system prompt that is prepended to every AI chat conversation.
...
public static class SystemPromptBuilder
{
    ...
    public static string Build(IEnumerable<string>? wheelPackageNames = null, string? catalogSchemaText = null)
    {
        ...
        sb.AppendLine("""
            You are an expert AI coding assistant embedded in Datateal — a polyglot data notebook and SQL query environment.

            ## Environment Overview

            Datateal runs Python kernels (via Jupyter/IPython) on Kubernetes compute nodes.
            ...
            - All SQL in Datateal is **DuckDB SQL**. Do NOT use PostgreSQL, MySQL, or Spark SQL syntax.
            ...
            This is the most important convention in Datateal:
        ...
        sb.AppendLine("""
            ...
            Datateal supports a `%run` magic command in Python cells:
            ```python
