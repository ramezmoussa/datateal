...
require(['vs/editor/editor.main'], function () {
    ...
    var builtinFunctions = [
        ...
        'any_value', 'apply', 'approx_count_distinct', 'approx_quantile', 'approx_top_k', 'arbitrary', 'arg_max', 'arg_max_null',
        'arg_max_nulls_last', 'arg_min', 'arg_min_null', 'arg_min_nulls_last', 'argmax', 'argmin', 'array_agg', 'array_aggr',
        'array_aggregate', 'array_append', 'array_apply', 'array_cat', 'array_concat', 'array_contains', 'array_cosine_distance', 'array_cosine_similarity',
        'array_cross_product', 'array_distance', 'array_distinct', 'array_dot_product', 'array_extract', 'array_filter', 'array_grade_up', 'array_has',
        'array_has_all', 'array_has_any', 'array_indexof', 'array_inner_product', 'array_intersect', 'array_length', 'array_negative_dot_product', 'array_negative_inner_product',
        'array_pop_back', 'array_pop_front', 'array_position', 'array_prepend', 'array_push_back', 'array_push_front', 'array_reduce', 'array_resize',
        'array_reverse', 'array_reverse_sort', 'array_select', 'array_slice', 'array_sort', 'array_to_json', 'array_to_string', 'array_to_string_comma_default',
        'array_transform', 'array_unique', 'array_value', 'array_where', 'array_zip', 'arrow_scan', 'arrow_scan_dumb', 'ascii',
        'asin', 'asinh', 'atan', 'atan2', 'atanh', 'avg', 'bar', 'base64',
        'bin', 'bit_and', 'bit_count', 'bit_length', 'bit_or', 'bit_position', 'bit_xor', 'bitstring',
        'bitstring_agg', 'bool_and', 'bool_or', 'can_cast_implicitly', 'cardinality', 'cast', 'cast_to_type', 'cbrt',
        'ceil', 'ceiling', 'char_length', 'character_length', 'check_peg_parser', 'chr', 'clear_httpfs_connection_cache', 'coalesce',
        'col_description', 'collations', 'combine', 'concat', 'concat_ws', 'constant_or_null', 'contains', 'copy_database',
        'corr', 'cos', 'cosh', 'cot', 'count', 'count_if', 'count_star', 'countif',
        'covar_pop', 'covar_samp', 'create_sort_key', 'cume_dist', 'current_catalog', 'current_connection_id', 'current_database', 'current_date',
        'current_localtime', 'current_localtimestamp', 'current_query', 'current_query_id', 'current_role', 'current_schema', 'current_schemas', 'current_setting',
        'current_transaction_id', 'current_user', 'currval', 'custom_histogram', 'damerau_levenshtein', 'database_list', 'database_size', 'date_add',
        'date_diff', 'date_part', 'date_sub', 'date_trunc', 'datediff', 'datepart', 'datesub', 'datetrunc',
        'dayname', 'dayofmonth', 'dayofweek', 'dayofyear', 'days_in_month', 'decode', 'degrees', 'dense_rank',
        'disable_checkpoint_on_shutdown', 'disable_logging', 'disable_object_cache', 'disable_optimizer', 'disable_peg_parser', 'disable_print_progress_bar', 'disable_profile', 'disable_profiling',
        'disable_progress_bar', 'disable_verification', 'disable_verify_external', 'disable_verify_fetch_row', 'disable_verify_parallelism', 'disable_verify_serializer', 'divide', 'duckdb_approx_database_count',
        'duckdb_columns', 'duckdb_connection_count', 'duckdb_constraints', 'duckdb_coordinate_systems', 'duckdb_databases', 'duckdb_dependencies', 'duckdb_extensions', 'duckdb_external_file_cache',
        'duckdb_functions', 'duckdb_indexes', 'duckdb_keywords', 'duckdb_log_contexts', 'duckdb_logs', 'duckdb_logs_parsed', 'duckdb_memory', 'duckdb_optimizers',
        'duckdb_prepared_statements', 'duckdb_profiling_settings', 'duckdb_schemas', 'duckdb_secret_types', 'duckdb_secrets', 'duckdb_sequences', 'duckdb_settings', 'duckdb_table_sample',
        ...
        'from_json', 'from_json_strict', 'fsum', 'gamma', 'gcd', 'gen_random_uuid', 'generate_series', 'generate_subscripts',
        'geomean', 'geometric_mean', 'get_bit', 'get_block_size', 'get_current_time', 'get_current_timestamp', 'get_type', 'get_ui_url',
        'getenv', 'getvariable', 'grade_up', 'greatest', 'greatest_common_divisor', 'group_concat', 'grouping', 'grouping_id',
        'hamming', 'has_any_column_privilege', 'has_column_privilege', 'has_database_privilege', 'has_foreign_data_wrapper_privilege', 'has_function_privilege', 'has_language_privilege', 'has_schema_privilege',
        'has_sequence_privilege', 'has_server_privilege', 'has_table_privilege', 'has_tablespace_privilege', 'hash', 'hex', 'histogram', 'histogram_exact',
        'histogram_values', 'icu_calendar_names', 'icu_collate_af', 'icu_collate_am', 'icu_collate_ar', 'icu_collate_ar_sa', 'icu_collate_as', 'icu_collate_az',
        'icu_collate_be', 'icu_collate_bg', 'icu_collate_bn', 'icu_collate_bo', 'icu_collate_br', 'icu_collate_bs', 'icu_collate_ca', 'icu_collate_ceb',
        'icu_collate_chr', 'icu_collate_cs', 'icu_collate_cy', 'icu_collate_da', 'icu_collate_de', 'icu_collate_de_at', 'icu_collate_dsb', 'icu_collate_dz',
        'icu_collate_ee', 'icu_collate_el', 'icu_collate_en', 'icu_collate_en_us', 'icu_collate_eo', 'icu_collate_es', 'icu_collate_et', 'icu_collate_fa',
        'icu_collate_fa_af', 'icu_collate_ff', 'icu_collate_fi', 'icu_collate_fil', 'icu_collate_fo', 'icu_collate_fr', 'icu_collate_fr_ca', 'icu_collate_fy',
        'icu_collate_ga', 'icu_collate_gl', 'icu_collate_gu', 'icu_collate_ha', 'icu_collate_haw', 'icu_collate_he', 'icu_collate_he_il', 'icu_collate_hi',
        'icu_collate_hr', 'icu_collate_hsb', 'icu_collate_hu', 'icu_collate_hy', 'icu_collate_id', 'icu_collate_id_id', 'icu_collate_ig', 'icu_collate_is',
        'icu_collate_it', 'icu_collate_ja', 'icu_collate_ka', 'icu_collate_kk', 'icu_collate_kl', 'icu_collate_km', 'icu_collate_kn', 'icu_collate_ko',
        'icu_collate_kok', 'icu_collate_ku', 'icu_collate_ky', 'icu_collate_lb', 'icu_collate_lij', 'icu_collate_lkt', 'icu_collate_ln', 'icu_collate_lo',
        'icu_collate_lt', 'icu_collate_lv', 'icu_collate_mk', 'icu_collate_ml', 'icu_collate_mn', 'icu_collate_mr', 'icu_collate_ms', 'icu_collate_mt',
        'icu_collate_my', 'icu_collate_nb', 'icu_collate_nb_no', 'icu_collate_ne', 'icu_collate_nl', 'icu_collate_nn', 'icu_collate_noaccent', 'icu_collate_nso',
        'icu_collate_om', 'icu_collate_or', 'icu_collate_pa', 'icu_collate_pa_in', 'icu_collate_pl', 'icu_collate_ps', 'icu_collate_pt', 'icu_collate_ro',
        'icu_collate_ru', 'icu_collate_sa', 'icu_collate_se', 'icu_collate_si', 'icu_collate_sk', 'icu_collate_sl', 'icu_collate_smn', 'icu_collate_sq',
        'icu_collate_sr', 'icu_collate_sr_ba', 'icu_collate_sr_me', 'icu_collate_sr_rs', 'icu_collate_st', 'icu_collate_sv', 'icu_collate_sw', 'icu_collate_ta',
        ...
        'json_group_array', 'json_group_object', 'json_group_structure', 'json_keys', 'json_merge_patch', 'json_object', 'json_pretty', 'json_quote',
        'json_serialize_plan', 'json_serialize_sql', 'json_structure', 'json_transform', 'json_transform_strict', 'json_tree', 'json_type', 'json_valid',
        'json_value', 'julian', 'kahan_sum', 'kurtosis', 'kurtosis_pop', 'lag', 'last_day', 'last_value',
        'lcase', 'lcm', 'lead', 'least', 'least_common_multiple', 'left_grapheme', 'len', 'length',
        'length_grapheme', 'levenshtein', 'lgamma', 'like_escape', 'list', 'list_aggr', 'list_aggregate', 'list_any_value',
        'list_append', 'list_apply', 'list_approx_count_distinct', 'list_avg', 'list_bit_and', 'list_bit_or', 'list_bit_xor', 'list_bool_and',
        'list_bool_or', 'list_cat', 'list_concat', 'list_contains', 'list_cosine_distance', 'list_cosine_similarity', 'list_count', 'list_distance',
        'list_distinct', 'list_dot_product', 'list_element', 'list_entropy', 'list_extract', 'list_filter', 'list_first', 'list_grade_up',
        'list_has', 'list_has_all', 'list_has_any', 'list_histogram', 'list_indexof', 'list_inner_product', 'list_intersect', 'list_kurtosis',
        'list_kurtosis_pop', 'list_last', 'list_mad', 'list_max', 'list_median', 'list_min', 'list_mode', 'list_negative_dot_product',
        'list_negative_inner_product', 'list_pack', 'list_position', 'list_prepend', 'list_product', 'list_reduce', 'list_resize', 'list_reverse',
        'list_reverse_sort', 'list_select', 'list_sem', 'list_skewness', 'list_slice', 'list_sort', 'list_stddev_pop', 'list_stddev_samp',
        'list_string_agg', 'list_sum', 'list_transform', 'list_unique', 'list_value', 'list_var_pop', 'list_var_samp', 'list_where',
        'list_zip', 'listagg', 'ln', 'log', 'log10', 'log2', 'lower', 'lpad',
        'ltrim', 'mad', 'make_date', 'make_time', 'make_timestamp', 'make_timestamp_ms', 'make_timestamp_ns', 'make_timestamptz',
        'make_type', 'map_concat', 'map_contains', 'map_contains_entry', 'map_contains_value', 'map_entries', 'map_extract', 'map_extract_value',
        ...
        'sinh', 'skewness', 'sleep_ms', 'sniff_csv', 'split', 'split_part', 'sql_auto_complete', 'sqrt',
        'st_asbinary', 'st_astext', 'st_aswkb', 'st_aswkt', 'st_crs', 'st_geomfromwkb', 'st_intersects_extent', 'st_setcrs',
        'start_ui', 'start_ui_server', 'starts_with', 'stats', 'stddev', 'stddev_pop', 'stddev_samp', 'stop_ui_server',
