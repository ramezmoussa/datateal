using Datateal.ControlPlane.Application.Mediator.Commands;
using Datateal.ControlPlane.Application.Mediator.Queries;
using Datateal.Core.Kernels;
using Datateal.Core.Mediator;
namespace Datateal.ControlPlane.Endpoints;
...
public static class NodeEndpoints
{
    public static IEndpointRouteBuilder MapNodeEndpoints(this IEndpointRouteBuilder endpoints)
    {
        ...
        // These forward to the datateal-runtime FastAPI running on the pod via
