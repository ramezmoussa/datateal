...
{
    Task<IReadOnlyList<JobSchedule>> GetEnabledSchedulesAsync(CancellationToken cancellationToken = default);
    ...
    Task UpdateNextFireTimeAsync(Guid id, DateTime? nextFireTime, CancellationToken cancellationToken = default);
}
