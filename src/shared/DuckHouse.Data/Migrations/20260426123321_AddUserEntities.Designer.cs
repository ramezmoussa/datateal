...
namespace DuckHouse.Data.Migrations
{
    ...
    [Migration("20260426123321_AddUserEntities")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DuckHouse.Core.Users.AppUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DuckHouse.Core.Users.UserCatalogAccess", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DuckHouse.Orchestrator.Core.Entities.InteractiveNodePoolConfig", b =>
                {
                    b.HasBaseType("DuckHouse.Orchestrator.Core.Entities.NodePoolConfig");

                    b.HasDiscriminator().HasValue("Interactive");
                });

            modelBuilder.Entity("DuckHouse.Orchestrator.Core.Entities.JobNodePoolConfig", b =>
                {
                    b.HasBaseType("DuckHouse.Orchestrator.Core.Entities.NodePoolConfig");
            ...
            modelBuilder.Entity("DuckHouse.Core.Users.UserCatalogAccess", b =>
                {
                    b.HasOne("DuckHouse.Core.Catalogs.Catalog", "Catalog")
                        .WithMany()
                        .HasForeignKey("CatalogId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DuckHouse.Core.Users.AppUser", "User")
